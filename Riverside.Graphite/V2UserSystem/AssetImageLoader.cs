...
public class AssetImageLoader : MarkupExtension
{
    ...
    public static BitmapImage LoadImage(string imageName)
    {
        ...
        var uri = new Uri($"ms-appx:///Riverside.Graphite.Core/Assets/{imageName}.png");
    ...
    {
        string assetsPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Riverside.Graphite.Core", "Assets");
    ...
    {
        return $"ms-appx:///Riverside.Graphite.Core/Assets/{imageName}.png";
    }
}