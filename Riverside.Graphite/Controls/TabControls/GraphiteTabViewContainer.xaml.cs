...
public sealed partial class GraphiteTabViewContainer : TabView
{
	...
	public TabViewLayouts.UILayout Mode
	{
		get => (TabViewLayouts.UILayout)GetValue(ModeProperty);
		set
		{
			ViewModel.Style = value switch
			{
				TabViewLayouts.UILayout.Modern => (Style)Application.Current.Resources["DefaultTabViewStyle"],
				TabViewLayouts.UILayout.Vertical => (Style)Application.Current.Resources["VerticalTabViewStyle"],
	...
	public static readonly DependencyProperty ModeProperty = DependencyProperty.Register(
		nameof(Mode),
		typeof(TabViewLayouts.UILayout),
		typeof(GraphiteTabViewContainer),
		new PropertyMetadata(TabViewLayouts.UILayout.Modern));
