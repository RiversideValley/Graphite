...
{
	public static readonly string LogFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "fire_Manger_Log.flog");
	public static readonly string InformationFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "fire_Manager_logger.log");
	public static readonly string MsalLogFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "fire_Manager_log_msalAuthenicaton.log");
