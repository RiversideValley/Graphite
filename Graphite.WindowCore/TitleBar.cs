...
public class TitleBar
{
	...
	private void TitleBar_PointerPressed(object sender, PointerRoutedEventArgs e)
	{
		if (e.GetCurrentPoint(_titleBarGrid).Properties.IsLeftButtonPressed)
		{
			...
			NativeMethods.SendMessage(_windowHandler.Hwnd, NativeMethods.WM_NCLBUTTONDOWN, NativeMethods.HT_CAPTION, IntPtr.Zero);
		}
	}
	...
	private void MaximizeRestoreButton_Click(object sender, RoutedEventArgs e)
	{
		...
		if (windowPlacement.showCmd == NativeMethods.SW_MAXIMIZE)
		{
			...
			_maximizeRestoreButton.Content = new FontIcon { Glyph = "\uE922", FontFamily = new Microsoft.UI.Xaml.Media.FontFamily("Segoe MDL2 Assets") };
		}
		else
		{
